...
<template>
  <Teleport to="body">
    <div
      ref="rootRef"
      class="fixed bottom-[max(2.5rem,calc(env(safe-area-inset-bottom)+1.5rem))] right-[max(1rem,env(safe-area-inset-right))] z-[60] flex flex-col items-end gap-3 cookie-float"
    >
    <Transition
